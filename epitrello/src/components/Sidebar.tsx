...
export function Sidebar() {
    ...
    fetch("/api/tableaux")
      ...
      .then((data) => {
        if (Array.isArray(data)) {
          setTableaux(data.slice(0, 5)); // Limit to 5 most recent
        } else if (data && Array.isArray(data.tableaux)) {
          setTableaux(data.tableaux.slice(0, 5));
        }
      })
      .catch(() => setTableaux([]))
  ...
  const navItems = [
    ...
    { href: "/tableaux", label: "Tableaux", icon: Layers },
      ...
      <nav className="flex-1 overflow-y-auto p-4">
        ...
        <div className="mt-6">
          ...
          {tableaux.length > 0 && (
            ...
            >
              <span className="font-medium">Voir tous les tableaux</span>
